package io.nanuvem.onetomany.masterdetails.demo.util;
...
public class BeanUtils extends BeanUtilsBean {
   ...
   * BeanUtils Instance
   */
  private static final io.nanuvem.onetomany.masterdetails.demo.util.BeanUtils INSTANCE = new io.nanuvem.onetomany.masterdetails.demo.util.BeanUtils();
