package io.nanuvem.onetoone.comboboxdemo.service;
...
import io.nanuvem.onetoone.comboboxdemo.model.Author;
import io.nanuvem.onetoone.comboboxdemo.repository.AuthorRepository;
import io.nanuvem.onetoone.comboboxdemo.util.BeanUtils;
...
public class AuthorService {
  ...
  public void preInsert(Author model) throws BusinessException {
    if (model.getBook() != null && model.getBook().getId() != null) {
      model.setBook(bookService.getOne(model.getBook().getId()));
    }
  }
