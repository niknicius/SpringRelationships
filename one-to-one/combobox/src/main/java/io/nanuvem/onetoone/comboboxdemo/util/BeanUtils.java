package io.nanuvem.onetoone.comboboxdemo.util;
...
public class BeanUtils extends BeanUtilsBean {
   ...
   * BeanUtils Instance
   */
  private static final io.nanuvem.onetoone.comboboxdemo.util.BeanUtils INSTANCE = new io.nanuvem.onetoone.comboboxdemo.util.BeanUtils();
