package io.nanuvem.manytomany.combobox.demo.util;
...
public class BeanUtils extends BeanUtilsBean {
   ...
   * BeanUtils Instance
   */
  private static final io.nanuvem.manytomany.combobox.demo.util.BeanUtils INSTANCE = new io.nanuvem.manytomany.combobox.demo.util.BeanUtils();
