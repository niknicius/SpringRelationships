package io.nanuvem.manytomany.associate.demo.util;
...
public class BeanUtils extends BeanUtilsBean {
   ...
   * BeanUtils Instance
   */
  private static final io.nanuvem.manytomany.associate.demo.util.BeanUtils INSTANCE = new io.nanuvem.manytomany.associate.demo.util.BeanUtils();
